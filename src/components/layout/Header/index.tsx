  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-gray-200 bg-white px-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="flex items-center gap-3">
        ...
        {user && (
          <div className="flex items-center gap-5 pl-2 border-l border-gray-400 dark:border-gray-700">
            ...
            <span className="text-lg font-medium hidden sm:block dark:text-gray-200">
              {user.username}
            </span>
          </div>
        )}
